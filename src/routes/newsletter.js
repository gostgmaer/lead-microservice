...
router.get('/subscribers', authenticate, requirePermission('newsletter:read'), async (req, res, next) => {
  try {
...
router.get('/stats', authenticate, requirePermission('newsletter:read'), async (req, res, next) => {
  try {
...
router.get('/subscriber/:id', authenticate, requirePermission('newsletter:read'), async (req, res, next) => {
  try {
...
router.patch('/subscriber/:id/tags', authenticate, requirePermission('newsletter:update'), async (req, res, next) => {
  try {
    const { tags } = req.body;
...
router.delete('/subscriber/:id', authenticate, requirePermission('newsletter:manage'), async (req, res, next) => {
  try {
