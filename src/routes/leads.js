...
// Elevated static routes (before /:id) — permission-based, not role-based.
router.get('/spam', requirePermission('lead:read_all'), ctrl.listSpam);
router.post('/proposals/expire-check', requirePermission('proposal:manage'), proposalCtrl.manualExpireCheck);
...
// Elevated param routes — permission-based, not role-based.
router.patch('/:id/spam', requirePermission('lead:update'), ctrl.toggleSpam);
router.delete('/:id/hard-delete', requirePermission('lead:delete'), ctrl.hardDelete);
router.patch('/:id/reopen-admin', requirePermission('lead:update'), ctrl.reopenAdmin);
