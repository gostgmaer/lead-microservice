...
const validateSubmitLead = [
	...
	body("category")
		.optional()
		.isIn(["General Inquiry", "Technical Support", "Sales", "Partnership", "Feedback", "Career", "Other"]),
...
const validateSendProposal = [
	...
	body("quotedCurrency")
		...
		.isAlpha()
		.withMessage("quotedCurrency must be a 3-letter currency code"),
...
const validateReviseProposal = [
	...
	body("revisionNote")
		...
		.notEmpty()
		.isLength({ max: 1000 })
		.withMessage("Revision note is required (max 1000 chars)"),
...
const validateDeclineProposal = [
	body("declinedReason")
		...
		.notEmpty()
		.isLength({ max: 1000 })
		.withMessage("Decline reason is required (max 1000 chars)"),
...
const validateAddAttachment = [
	...
	body("attachments.*.fileId")
		...
		.notEmpty()
		.withMessage("Each attachment must have a fileId"),
	...
	body("attachments.*.filename")
		.if(body("attachments").exists())
		.notEmpty()
		.withMessage("Each attachment must have a filename"),
