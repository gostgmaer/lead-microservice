...
export const STATUS_ENUM = [
  ...
  'proposal_expired', 'quotation_sent', 'invoice_sent', 'negotiation', 'contract_sent', 'contract_signed',
...
// Which brand/site the lead came in through, so kishor (portfolio) vs easydev
// (agency site) inquiries can be distinguished, filtered and reported on.
export const BRAND_ENUM = ['easydev', 'kishor'];
...
const leadSchema = new mongoose.Schema(
  {
    ...
    email:     { type: String, required: true, lowercase: true, trim: true, get: decrypt, set: encrypt },
    ...
    contractSentBy:   { type: String },
    contractSignedAt: { type: Date },
    contractNote:     { type: String },

    source:      { type: String, enum: SOURCE_ENUM, default: 'website' },
    // Brand/site of origin — defaults to easydev; portfolio submissions set 'kishor'.
    brand:       { type: String, enum: BRAND_ENUM, default: 'easydev', index: true },
    medium:      { type: String },
